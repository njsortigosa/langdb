 ...
 */
$config['site_title']                 = "Local Language Database";       // Site Title, example.com
$config['admin_email']                = "njsortigosa@wvsu.edu.ph"; // Admin Email, admin@example.com
$config['default_group']              = 'editors';           // Default group, use name
