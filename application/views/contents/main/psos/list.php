                    ...
                    <table class="table table-striped table-bordered" style="width:100%!important;">
                        <thead>
                            <tr>
                                    ...
                                    <a href="<?=base_url();?>main/add_pos" class="btn btn-sm btn-success fancybox"><i class="glyphicon glyphicon-plus"> </i></a>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $rpos = $this->langdb_model->get_psos();
                            foreach($rpos->result() as $pos){ ?>
                            <tr>
                                                                
                                                                        <td><?=$pos->pos;?></td>
                                                                                                <td style="text-align: center;" class="td-actions">
                                    <a href="<?=base_url();?>main/edit_pos/<?=$pos->id;?>" title="Edit" class="btn btn-sm btn-warning fancybox"><i class="glyphicon glyphicon-edit"> </i></a>
